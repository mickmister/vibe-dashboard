...
environment=CODEX_SQLITE_LOGS="off",PORT="%(ENV_CODE_PORT)s",CODE_PASSWORD="%(ENV_CODE_PASSWORD)s",HOME="/home/vkuser",XDG_CONFIG_HOME="/home/vkuser/.config",PATH="/usr/local/lib/vk-bd-wrapper/bin:/var/lib/vd/plugin-bin:/var/lib/vd/toolchains/bin:/var/lib/vd/toolchains/npm/bin:/home/vkuser/.npm-global/bin:/usr/local/cargo/bin:/usr/local/go/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
user=vkuser`;
...
stderr_logfile=/dev/fd/2
stderr_logfile_maxbytes=0
environment=CODEX_SQLITE_LOGS="off",HOST="0.0.0.0",PORT="%(ENV_BACKEND_PORT)s",ENABLE_VIBE_KANBAN="%(ENV_ENABLE_VIBE_KANBAN)s",VK_BUILD_VERSION_FILE="/usr/local/share/vibe-kanban-build-version",VK_SHARED_API_BASE="%(ENV_VK_SHARED_API_BASE)s",VK_ALLOWED_ORIGINS="%(ENV_VK_ALLOWED_ORIGINS)s",HOME="/home/vkuser",XDG_CONFIG_HOME="/home/vkuser/.config",PATH="/usr/local/lib/vk-bd-wrapper/bin:/var/lib/vd/plugin-bin:/var/lib/vd/toolchains/bin:/var/lib/vd/toolchains/npm/bin:/home/vkuser/.npm-global/bin:/usr/local/cargo/bin:/usr/local/go/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
user=vkuser
...
stderr_logfile=/dev/fd/2
stderr_logfile_maxbytes=0
environment=CODEX_SQLITE_LOGS="off",HOST="0.0.0.0",PORT="%(ENV_DASHBOARD_PORT)s",VD_PLUGIN_INSTALL_ROOT="/var/lib/vd/plugins",HOME="/home/vkuser",XDG_CONFIG_HOME="/home/vkuser/.config",PATH="/usr/local/lib/vk-bd-wrapper/bin:/var/lib/vd/plugin-bin:/var/lib/vd/toolchains/bin:/var/lib/vd/toolchains/npm/bin:/home/vkuser/.npm-global/bin:/usr/local/cargo/bin:/usr/local/go/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
user=vkuser
...
command=sh -c 'if [ "\${VD_NUDGE_DAEMON_ENABLED:-}" != "true" ]; then echo "vibe-agent nudge daemon disabled (VD_NUDGE_DAEMON_ENABLED != true)"; exec tail -f /dev/null; fi; exec node /opt/vibe-kanban-vscode-web-seed/dist/vibe-agent/nudge/daemon.js'
autostart=true
autorestart=true
startsecs=0
stdout_logfile=/dev/fd/1
...
stderr_logfile=/dev/fd/2
stderr_logfile_maxbytes=0
environment=CODEX_SQLITE_LOGS="off",VIBE_API_URL="http://127.0.0.1:%(ENV_BACKEND_PORT)s",HOME="/home/vkuser",XDG_CONFIG_HOME="/home/vkuser/.config",PATH="/usr/local/lib/vk-bd-wrapper/bin:/var/lib/vd/plugin-bin:/var/lib/vd/toolchains/bin:/var/lib/vd/toolchains/npm/bin:/home/vkuser/.npm-global/bin:/usr/local/cargo/bin:/usr/local/go/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
user=vkuser
directory=/home/vkuser/repos`;
...
stderr_logfile=/dev/fd/2
stderr_logfile_maxbytes=0
environment=HOME="/root",PATH="/usr/local/lib/vk-bd-wrapper/bin:/var/lib/vd/plugin-bin:/var/lib/vd/toolchains/bin:/var/lib/vd/toolchains/npm/bin:/home/vkuser/.npm-global/bin:/usr/local/cargo/bin:/usr/local/go/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
user=root`;
...
command=/usr/local/bin/process-exporter -config.path /etc/process-exporter/process-exporter.yml -web.listen-address=0.0.0.0:9256 -children=true -threads=false -remove-empty-groups
autostart=true
autorestart=true
startsecs=0
stdout_logfile=/dev/fd/1
...
export const BUILTIN_FIRST_PARTY_SERVICE_PLUGINS: FirstPartyServicePlugin[] = [
...

  {
    manifest: manifest({
      ...
      version: 'bundled',
      requestedCapabilities: { vkHttpApi: 'agentPrompt', hostShell: { commands: ['node /opt/vibe-kanban-vscode-web-seed/dist/vibe-agent/nudge/daemon.js'] }, filesystem: [{ scope: 'absolute', path: '/var/lib/vd/nudge-daemon', access: 'readWrite' }], network: { mode: 'egress' }, env: ['VD_NUDGE_DAEMON_ENABLED'] },
