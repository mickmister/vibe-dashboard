...
export const databaseVersion = 22;
...
export const migrations = [
  ...
  { name: '20260722000000_workflow_runs', migration: workflowRunsMigration },
  { name: '20260722010000_workflow_run_indexes', migration: workflowRunIndexesMigration },
  { name: '20260731000000_workflow_orchestration', migration: workflowOrchestrationMigration },
  { name: '20260731010000_workflow_role_session_bindings', migration: workflowRoleSessionBindingsMigration },
  { name: '20260804000000_workflow_external_waits', migration: workflowExternalWaitsMigration },
  { name: '20260804010000_response_pipes', migration: responsePipesMigration },
  { name: '20260804020000_factory_work_items', migration: factoryWorkItemsMigration },
  { name: '20260804030000_declarative_workflow_definitions', migration: declarativeWorkflowDefinitionsMigration },
  { name: '20260808000000_workflow_webhook_inbox', migration: workflowWebhookInboxMigration },
  { name: '20260808010000_workflow_webhook_provisioning', migration: workflowWebhookProvisioningMigration },
  { name: '20260811000000_workflow_attention_items', migration: workflowAttentionItemsMigration },
  { name: '20260811010000_workflow_design_library', migration: workflowDesignLibraryMigration },
  { name: '20260811020000_workflow_persisted_runs', migration: workflowPersistedRunsMigration },
  { name: '20260811030000_workflow_batches', migration: workflowBatchesMigration },
  { name: '20260814000000_workspace_lanes', migration: workspaceLanesMigration },
  { name: '20260815000000_workflow_meta_runs', migration: workflowMetaRunsMigration },
