...
describe('BeadsForm single-question mode', () => {
  ...
  it('shows a compact review step with answers before submit and edits jump back to the question', () => {
        ...
        <form>
          <fieldset>
            ...
            <div class="beads-form-choice">
              <label for="scope_fix"><input id="scope_fix" name="scope" type="checkbox" value="fix" checked> Fix the bug <span class="beads-form-assumption" aria-label="Author assumption, not selected">Assumed true</span></label>
    ...
    expect(review.textContent).not.toContain('Selected choices: Fix the bug Assumed true');
