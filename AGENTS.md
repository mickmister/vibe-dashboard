...
This project is indexed by GitNexus as **vibe-dashboard** (1298 symbols, 2941 relationships, 108 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
