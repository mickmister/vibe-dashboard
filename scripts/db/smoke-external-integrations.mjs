...
const migrationPath = join(process.cwd(), 'db/dialects/sqlite/migrations/20260702000000_external_integrations/migration.sql');
...
try {
  ...
  db.prepare('INSERT INTO "Migration" ("name") VALUES (?)').run('20260702000000_external_integrations');
  ...
  db.close();
  console.log('External integrations DB smoke passed (1 migration applied)');
} finally {
