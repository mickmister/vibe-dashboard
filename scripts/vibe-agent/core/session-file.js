 ...
 */
export function ensureWorkspaceDataDir() {
 ...
 */
export function findWorktreeRoot(cwd) {
 ...
 */
export function getSessionFilePath(workspaceId) {
 ...
 */
export function readSessionFile(workspaceId) {
 ...
 */
export function writeSessionFile(workspaceId, data) {
 ...
 */
export function findSessionByRole(workspaceId, role) {
 ...
 */
export function getRoleForSession(workspaceId, sessionId) {
    const sessionFile = readSessionFile(workspaceId);
 ...
 */
export function registerSession(workspaceId, sessionId, role) {
    const sessionFile = readSessionFile(workspaceId);
 ...
 */
export function unregisterSession(workspaceId, sessionId) {
    const sessionFile = readSessionFile(workspaceId);
    delete sessionFile[sessionId];
    writeSessionFile(workspaceId, sessionFile);
}
