...
export function createSandboxPlan(input: {
  ...
  const commonEnv = {
    ...
    VK_QA_MODE: '1',
    QA_MODE: '1',
    ...(env.VD_WORKFLOWS_ENABLED ? { VD_WORKFLOWS_ENABLED: env.VD_WORKFLOWS_ENABLED } : {}),
    ...(env.VITE_VD_WORKFLOWS_ENABLED ? { VITE_VD_WORKFLOWS_ENABLED: env.VITE_VD_WORKFLOWS_ENABLED } : {}),
    ...(env.VD_WORKFLOW_E2E_FIXTURES_ENABLED ? { VD_WORKFLOW_E2E_FIXTURES_ENABLED: env.VD_WORKFLOW_E2E_FIXTURES_ENABLED } : {}),
    ...(env.VITE_VD_WORKFLOW_E2E_FIXTURES_ENABLED ? { VITE_VD_WORKFLOW_E2E_FIXTURES_ENABLED: env.VITE_VD_WORKFLOW_E2E_FIXTURES_ENABLED } : {}),
  };
